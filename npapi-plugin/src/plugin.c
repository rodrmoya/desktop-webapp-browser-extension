...
#define PLUGIN_DESCRIPTION "Desktop integration for Chrome apps"
...
{
    g_debug ("%s()", G_STRFUNC);
    return "application/x-desktop-webapp:none:" PLUGIN_NAME;
}
...
NPP_GetValue (NPP instance, NPPVariable variable, void *value)
{
  ...
  case NPPVpluginScriptableNPObject:
    *(NPObject **)value = webapp_create_plugin_object (instance);
    break;
...
NPIdentifier
NPN_GetIntIdentifier (int32_t id)
{
  g_return_val_if_fail (browser_funcs != NULL, 0);
